...
class BahasaIndonesia extends CI_Controller
{
    ...
    public function index()
    {
        ...
        WHERE mata_pelajaran.mata_pelajaran='Bahasa Indonesia' and tr_absen_siswa.nis=$nis;";
        ...
        $this->load->view('users/siswa/absen/bahasaIndonesia');
