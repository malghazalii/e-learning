                  ...
                  <form>
                     <table width="452" cellpadding="5" cellspacing="1" style="padding: 2px">
                        ...
                        <tr>
                           <td>Kelas</td>
                           <td>:</td>
                           <td><input type=text size="16" id="kelas" name="kelas"></textarea>
                           <td>
                        </tr>
                        <tr>
                           <td>Jurusan</td>
                           <td>:</td>
                           <td><input type=text size="16" id="jurusan" name="jurusan"></textarea>
                           <td>
                        </tr>
                        <tr>
                           <td>Mata Pelajaran</td>
                           <td>:</td>
                           <td><input type=text size="16" id="mapel" name="mapel"></textarea>
                           <td>
                        </tr>
                     </table>
                  </form>
