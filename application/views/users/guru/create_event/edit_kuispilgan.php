            ...
            <div class="control-group after-add-more">
              ...
              <div class="form-group">
                <div class="row">
                  ...
                  <div class="col-sm-3">
                    <input type="file" name="file_input1" id="file_input1" class="btn btn-success upload">
                  </div>
                  <div class="col-sm-6">
              ...
              <div class="form-group">
                <div class="row">
                  ...
                  <div class="col-sm-3">
                    <input type="file" name="file_input2" id="file_input2" class="btn btn-success upload">
                  </div>
                  <div class="col-sm-6">
              ...
              <div class="form-group">
                <div class="row">
                  ...
                  <div class="col-sm-3">
                    <input type="file" name="file_input3" id="file_input3" class="btn btn-success upload">
                  </div>
                  <div class="col-sm-6">
              ...
              <div class="form-group">
                <div class="row">
                  ...
                  <div class="col-sm-3">
                    <input type="file" name="file_input4" id="file_input4" class="btn btn-success upload">
                  </div>
                  <div class="col-sm-6">
              ...
              <div class="form-group">
                <div class="row">
                  ...
                  <div class="col-sm-3">
                    <input type="file" name="file_input5" id="file_input5" class="btn btn-success upload">
                  </div>
                  <div class="col-sm-6">
