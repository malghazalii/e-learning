<div class="details-w3l py-5">
		<div class="container">
			...
			<div class="row inner_sec_info py-xl-5 py-lg-3">
				<!-- left side -->
				<div class="col-lg-8 single-left">
					<div class="single-left1">
						<h6 class="details-heading font-italic my-4">E-Learning SMAN 1 Bondowoso</h6>
						<h5 class="card-title">
				...
				<div class="col-lg-4 event-right mt-lg-0 mt-sm-5 mt-4">
					<div class="event-right1">
						<div class="posts p-4 border">
							<h3 class="blog-title text-dark">Tugas Lampau</h3>
							<div class="posts-grids">
								<div class="row posts-grid mt-4">
									<div class="col-lg-4 col-md-3 col-4 posts-grid-left pr-0">
										<a href="course_details.html">
										<img src="<?php echo base_url(); ?>assets/users/images/late-fee.png" alt=" " class="img-fluid" />
										</a>
									</div>
						...
						<br>
						<div class="posts p-4 border">
							<h3 class="blog-title text-dark">Tugas Terbaru</h3>
							<div class="posts-grids">
								<div class="row posts-grid mt-4">
									<div class="col-lg-4 col-md-3 col-4 posts-grid-left pr-0">
										<a href="course_details.html">
										<img src="<?php echo base_url(); ?>assets/users/images/document.png" alt=" " class="img-fluid" />
										</a>
									</div>
									<div class="col-lg-8 col-md-7 col-8 posts-grid-right mt-lg-0 mt-md-5 mt-sm-4">
										<h4>
